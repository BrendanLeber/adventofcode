...
a giant [tractor beam][1] on [Triton][2]!  You have no choice but to land.
...
given letter open the door of the same letter: `a` opens `A`, `b` opens `B`,
...
- Shortest paths are `136` steps; one is: `a`, `f`, `b`, `j`, `g`, `n`, `h`,
  `d`, `l`, `o`, `e`, `p`, `c`, `i`, `k`, `m`.
...
- Shortest paths are `81` steps; one is: `a`, `c`, `f`, `i`, `d`, `g`, `b`,
  `e`, `h`.
